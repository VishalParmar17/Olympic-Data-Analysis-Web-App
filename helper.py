...
def most_successful(df, sport):
    ...
    x.columns = ['Name', 'Medals']  # Rename columns appropriately
...
def most_successful_countrywise(df, country):
    ...
    top_10_athletes = x.head(10)
    result_df = top_10_athletes.merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport']].drop_duplicates('Name')
